	...
	XMMATRIX baseViewMatrix)
{
	...
	// Now update the sentence vertex buffer with the new string information.
	result = UpdateSentence(m_sentence2, "Im WhatSseob!", 100, 200, 1.0f, 1.0f, 0.0f, deviceContext);
	if (!result)
	{
		return false;
	}
	...
	// Now update the sentence vertex buffer with the new string information.
	result = UpdateSentence(m_sentence3, "ByeBye", 100, 300, 1.0f, 0.0f, 0.0f, deviceContext);
	if (!result)
	{
		return false;
	}
