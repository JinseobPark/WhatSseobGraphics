...
struct ShadowMapping_ApplyShadowTorus_Pixel_Shader_VS_INPUT
{
   float4 mClipPosition : TEXCOORD1;
   float mDiffuse : TEXCOORD2;
};
...
<
   ...
   bool UIVisible =  true;
> = float4( 0.96, 1.00, 0.05, 1.00 );

float4 ShadowMapping_ApplyShadowTorus_Pixel_Shader_ps_main(ShadowMapping_ApplyShadowTorus_Pixel_Shader_VS_INPUT Input) : COLOR
{
