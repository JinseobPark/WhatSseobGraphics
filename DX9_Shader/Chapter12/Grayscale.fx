...
struct ColorConversion_Grayscale_Pixel_Shader_VS_INPUT
{
   float2 mUV : TEXCOORD0;
};
...
float4 ColorConversion_Grayscale_Pixel_Shader_ps_main(ColorConversion_Grayscale_Pixel_Shader_VS_INPUT Input) : COLOR
{   
