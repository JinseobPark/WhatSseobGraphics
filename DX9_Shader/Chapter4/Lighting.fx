...
// Pass 0
//--------------------------------------------------------------//
string Lighting2_Pass_0_Model : ModelData = "..\\..\\..\\..\\..\\..\\..\\program files (x86)\\amd\\rendermonkey 1.82\\Examples\\Media\\Models\\Sphere.3ds";
...
float4 gWorldLight
<
   string UIName = "gWorldLight";
   string UIWidget = "Direction";
   bool UIVisible =  false;
   float4 UIMin = float4( -10.00, -10.00, -10.00, -10.00 );
   float4 UIMax = float4( 10.00, 10.00, 10.00, 10.00 );
   bool Normalize =  false;
> = float4( 000.00, 000.00, -500.00, 1.00 );
...
VS_OUTPUT Lighting2_Pass_0_Vertex_Shader_vs_main(VS_INPUT Input)
{
   ...
   float3 lightDir = Output.mPosition.xyz - gWorldLight.xyz;
