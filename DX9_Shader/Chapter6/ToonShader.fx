...
VS_OUTPUT ToonShader_Pass_0_Vertex_Shader_vs_main( VS_INPUT Input )
{
   ...
   Output.mPosition = mul(Input.mPosition, gMVPMatrix);
...
struct ToonShader_Pass_0_Pixel_Shader_VS_INPUT
{
   float3 mDiffuse : TEXCOORD1;
};
...
float4 ToonShader_Pass_0_Pixel_Shader_ps_main(ToonShader_Pass_0_Pixel_Shader_VS_INPUT Input) : COLOR0
{   
