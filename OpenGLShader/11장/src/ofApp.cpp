...
void ofApp::drawWater(DirectionalLight& dirLight, glm::mat4& proj, glm::mat4& view)
{
	...
	shd.setUniform3f("ambientCol", glm::vec3(0, 0, 0));
...
void ofApp::drawCube(glm::mat4& proj, glm::mat4& view)
{
	...
	mat4 rot = rotate(radians(rotAngle), vec3(0, 1, 0));
	mat4 scal = scale(vec3(0.4, 0.4, 0.4));
	mat4 model = translate(vec3(0.0, 0.75, 0.0f)) * rot * scal;
	mat4 mvp = proj * view * model;
